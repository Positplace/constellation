...
const DetailedWorldMap: React.FC = () => {
  const worldMapData = useMemo(() => {
    ...
    const northAmerica = createDetailedContinent(
      [
    ...
    const southAmerica = createDetailedContinent(
      [
    ...
    const europe = createDetailedContinent(
      [
    ...
    const asia = createDetailedContinent(
      [
    ...
    const africa = createDetailedContinent(
      [
    ...
    const australia = createDetailedContinent(
      [
