...
const RealisticWorldMap: React.FC = () => {
  const worldMapData = useMemo(() => {
    ...
    // Create realistic continent shape using proper triangulation
    const createRealisticContinent = (
    ...
    // Realistic continent outlines using actual geographic coordinates
    const northAmerica = createRealisticContinent(
      [
    ...
    const southAmerica = createRealisticContinent(
      [
        // South America - realistic outline
        [12, -80],
        [15, -70],
        [10, -60],
        [5, -50],
    ...
    const europe = createRealisticContinent(
      [
        // Europe - realistic outline
        [71, -10],
        [70, 0],
        [65, 10],
        [60, 20],
    ...
    const asia = createRealisticContinent(
      [
        // Asia - realistic outline
        [71, 40],
        [70, 60],
        [65, 80],
        [60, 100],
    ...
    const africa = createRealisticContinent(
      [
    ...
    const australia = createRealisticContinent(
      [
        // Australia - realistic outline
        [-10, 110],
        [-5, 120],
        [0, 130],
        [5, 140],
