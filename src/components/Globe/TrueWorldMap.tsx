...
const TrueWorldMap: React.FC = () => {
  const worldMapData = useMemo(() => {
    ...
    const northAmerica = createTrueContinent(
      [
    ...
    const southAmerica = createTrueContinent(
      [
    ...
    const europe = createTrueContinent(
      [
    ...
    const asia = createTrueContinent(
      [
    ...
    const africa = createTrueContinent(
      [
    ...
    const australia = createTrueContinent(
      [
