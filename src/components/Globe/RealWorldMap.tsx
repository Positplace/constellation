...
const RealWorldMap: React.FC = () => {
  const worldMapData = useMemo(() => {
    ...
    const northAmerica = createRealContinent(
      [
    ...
    const southAmerica = createRealContinent(
      [
    ...
    const europe = createRealContinent(
      [
    ...
    const asia = createRealContinent(
      [
    ...
    const africa = createRealContinent(
      [
    ...
    const australia = createRealContinent(
      [
