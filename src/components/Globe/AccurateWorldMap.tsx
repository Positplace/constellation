...
const AccurateWorldMap: React.FC = () => {
  const worldMapData = useMemo(() => {
    ...
    const northAmerica = createAccurateContinent(
      [
    ...
    const southAmerica = createAccurateContinent(
      [
    ...
    const europe = createAccurateContinent(
      [
    ...
    const asia = createAccurateContinent(
      [
    ...
    const africa = createAccurateContinent(
      [
    ...
    const australia = createAccurateContinent(
      [
